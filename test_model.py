...
model_path = "data/models/pauls_models/leaky_relu_mixed/generator.keras"
gan_model = tf.keras.models.load_model(model_path)

save_path = "data/orderly output/original_gan_tiantian_mixed_lbbb_metrics.csv"
...
save_path = "data/orderly output/original_gan_tiantian_mixed_idiohealthy_metrics.csv"
data_path = [
...
generator1_path = "data/models/pauls_models/original_gan_tiantian_mixed/generator.keras"
discriminator1_path = "data/models/pauls_models/original_gan_tiantian_mixed/discriminator.keras"
